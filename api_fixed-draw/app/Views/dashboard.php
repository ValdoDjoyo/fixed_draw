                ...
                <div class="row justify-content-center">
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total des pass Générés</h3>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total des pass Actifs</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="white-box analytics-info">
                            <h3 class="box-title">Total des pass expirés</h3>
                            <ul class="list-inline two-part d-flex align-items-center mb-0">
                                <li>
                    ...
                    <div class="col-md-12 col-lg-12 col-sm-12">
                        <div class="white-box">
                            <div class="d-md-flex mb-3">
                                <h3 class="box-title mb-0">Matchs récement ajoutés</h3>
                                ...
                                <table class="table no-wrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="border-top-0">Domicile</th>
                                            <th class="border-top-0">Score 1</th>
                                            <th class="border-top-0">Score 2</th>
                                            <th class="border-top-0">Exterieur</th>
                                        </tr>
                                    </thead>
                                    <tbody>
